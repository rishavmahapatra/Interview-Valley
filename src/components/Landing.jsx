...
export default function Landing() {
  ...
  return (
    <div>
          ...
          <div>
            <div className="relative mx-auto max-w-5xl my-20 sm:py-38 ">
              <div className=" hidden sm:mb-8 sm:flex sm:justify-center">
                <div className=" relative antialiased rounded-full px-3 py-2 text-md leading-6 text-blue-100 ring-1 ring-primary-600/10 hover:ring-primary-600/20">
              ...
              <div className="fade-in antialiased text-center mx-auto ">
                ...
                <h1 className="text-5xl py-2 sm:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-indigo-200 to-purple-200 tracking-tight ">
                ...
                <div className="relative mx-auto mt-10 mb-16 flex justify-center max-w-4xl w-full">
                  <iframe
                    className="rounded-lg shadow-md shadow-indigo-400 sm:w-[640px] h-[360px] w-full"
      ...
      <div className="relative  min-h-screen ">
        <h1 className="mx-auto text-center text-3xl font-bold sticky top-24 ">Features</h1>
      </div>
      <div className="relative  min-h-screen">
